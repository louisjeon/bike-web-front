...
const Convenience = () => {
    ...
    return(
        <>
            <MainImgWrapper ref={(el) => refs.current[0] = el} data-index={0} inView={inView[0]}>
                <Img src={img1}/>
                ...
                <SubWrapper3>
                    <SubWrapper2>
                        ...
                        <SubWrapper ref={(el) => refs.current[2] = el} data-index={2} inView={inView[2]}>
                            ...
                            <SubContent>바쁜 낮이나 밤에 2.5시간을 할애하여 ebii를 충전하면, 거의 또는 전혀 시간을 들일 필요 없이 100%로 충전됩니다. 이동 중에도 유지 됩니다!</SubContent>
                            <SubImg src={img1}/>
                        </SubWrapper>
                    </SubWrapper2>
                    <SubWrapper ref={(el) => refs.current[3] = el} data-index={3} inView={inView[3]}>
                        <SubTitle>자동 잠금 해제</SubTitle>
                        <SubContent>늘 이동할 준비가 되어 있습니다. ebii의 무선 Bluetooth 연결은 라이더가 자전거를 떠날 때 자동으로 잠그고 가까이 있을 때 다시 잠금을 해제합니다.</SubContent>
                        <SubImg src={img1}/>
                    </SubWrapper>
                </SubWrapper3>
                <SubWrapper ref={(el) => refs.current[4] = el} data-index={4} inView={inView[4]}> 
                    <SubTitle>전원 공유.</SubTitle>
                    <SubContent>탈착식 배터리로 가정에서 편하게 충전할 수 있을 뿐 아니라, 휴대폰 및 노트북에 휴대용 충전기로도 쓰입니다. 전원을 공유하세요!.</SubContent>
                    <SubImg src={img1}/>
                </SubWrapper>
            </SubContainer>
        </>
