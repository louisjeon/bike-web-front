        ...
        <ContentWrapper>
            <MainContainer>
                <MainAnimdation ref={(el) => refs.current[0] = el} data-index={0} inView={inView[0]}>
                    ...
                    <MainContent>Quadstar가 도시 이동을 수월하게 해줍니다.<br></br><br></br>주변 세상에서 적극적인 참여자가 되거나 다음 목적지로 향해 보세요. 선택은 여러분의 몫입니다.</MainContent>
                </MainAnimdation>
            </MainContainer>
            <SubContainer>
                <SubWrapper ref={(el) => refs.current[1] = el} data-index={1} inView={inView[1]}>
                    <SubTitle>수월한<br></br>라이딩</SubTitle>
                    <Content>스마트 AI 기능으로 매일 라이딩이 수월해집니다. Quadstar가 라이더의 스타일과 선호도에 적응하여 라이더에게 최적화도니 여정을 제공합니다!</Content>
                </SubWrapper>
                ...
                <SubWrapper ref={(el) => refs.current[3] = el} data-index={3} inView={inView[3]}>
                    ...
                    <Content>지인들과 모이거나, 출근을 좀 늦게 하거나, 아니면 단순히 시간을 보내든, Quadstar가 라이더를 안전하고 건강하게 모십니다.</Content>
                </SubWrapper>
            </SubContainer>
        </ContentWrapper>
    );
