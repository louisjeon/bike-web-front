  ...
  return(
    <>
      <ContentWrapper>
        ...
        <P>언제나 당신과 함께입니다.</P>
        <P className="sub">언제 어디서나 당신의 안전과 즐거움을 최우선으로 생각합니다. 모든 순간을 안전하게, 모든 여정을 신나게!</P>
      </ContentWrapper>
      <ContentWrapper>
        <Banner className="joyful">Joyful</Banner>
        <P>Joyful</P>
        <P className="sub">안전함과 즐거움이 공존하는 라이딩 경험을 제공합니다. 최고의 성능과 안전성으로 설계된 자전거로 일상의 즐거움을 더하세요.</P>
      </ContentWrapper>
      <ContentWrapper>
        <Banner className="safety">Safety</Banner>
        <P>Safety</P>
        <P className="sub">당신의 소중한 여정에 든든한 안전을 더합니다. 혁신적인 기술과 신뢰할 수 있는 품질로 더욱 안심할 수 있는 라이딩을 선사합니다.</P>
      </ContentWrapper>
    </>
  );
};
